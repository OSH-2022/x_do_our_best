...
def fun():
    ...
    jroute0 = shortest_way.remote(Location[0], 5)
    jroute1 = shortest_way.remote(Location[1], 5)
    jnew_route1 = merge_route.remote(jroute0, jroute1)
    jroute2 = shortest_way.remote(Location[2], 5)
    jnew_route2 = merge_route.remote(jnew_route1, jroute2)
    jroute3 = shortest_way.remote(Location[3], 5)
    jnew_route3 = merge_route.remote(jnew_route2, jroute3)
    jroute4 = shortest_way.remote(Location[4], 5)
    jnew_route4 = merge_route.remote(jnew_route3, jroute4)
    jroute5 = shortest_way.remote(Location[4], 5)
    jnew_route5 = merge_route.remote(jnew_route4, jroute5)

    kroute0 = shortest_way.remote(Location[0], 5)
    kroute1 = shortest_way.remote(Location[1], 5)
    knew_route1 = merge_route.remote(kroute0, kroute1)
    kroute2 = shortest_way.remote(Location[2], 5)
    knew_route2 = merge_route.remote(knew_route1, kroute2)
    kroute3 = shortest_way.remote(Location[3], 5)
    knew_route3 = merge_route.remote(knew_route2, kroute3)
    kroute4 = shortest_way.remote(Location[4], 5)
    knew_route4 = merge_route.remote(knew_route3, kroute4)
    kroute5 = shortest_way.remote(Location[4], 5)
    knew_route5 = merge_route.remote(knew_route4, kroute5)

    lroute0 = shortest_way.remote(Location[0], 5)
    lroute1 = shortest_way.remote(Location[1], 5)
    lnew_route1 = merge_route.remote(lroute0, lroute1)
    lroute2 = shortest_way.remote(Location[2], 5)
    lnew_route2 = merge_route.remote(lnew_route1, lroute2)
    lroute3 = shortest_way.remote(Location[3], 5)
    lnew_route3 = merge_route.remote(lnew_route2, lroute3)
    lroute4 = shortest_way.remote(Location[4], 5)
    lnew_route4 = merge_route.remote(lnew_route3, lroute4)
    lroute5 = shortest_way.remote(Location[4], 5)
    lnew_route5 = merge_route.remote(lnew_route4, lroute5)

    mroute0 = shortest_way.remote(Location[0], 5)
    mroute1 = shortest_way.remote(Location[1], 5)
    mnew_route1 = merge_route.remote(mroute0, mroute1)
    mroute2 = shortest_way.remote(Location[2], 5)
    mnew_route2 = merge_route.remote(mnew_route1, mroute2)
    mroute3 = shortest_way.remote(Location[3], 5)
    mnew_route3 = merge_route.remote(mnew_route2, mroute3)
    mroute4 = shortest_way.remote(Location[4], 5)
    mnew_route4 = merge_route.remote(mnew_route3, mroute4)
    mroute5 = shortest_way.remote(Location[4], 5)
    mnew_route5 = merge_route.remote(mnew_route4, mroute5)

    nroute0 = shortest_way.remote(Location[0], 5)
    nroute1 = shortest_way.remote(Location[1], 5)
    nnew_route1 = merge_route.remote(nroute0, nroute1)
    nroute2 = shortest_way.remote(Location[2], 5)
    nnew_route2 = merge_route.remote(nnew_route1, nroute2)
    nroute3 = shortest_way.remote(Location[3], 5)
    nnew_route3 = merge_route.remote(nnew_route2, nroute3)
    nroute4 = shortest_way.remote(Location[4], 5)
    nnew_route4 = merge_route.remote(nnew_route3, nroute4)
    nroute5 = shortest_way.remote(Location[4], 5)
    nnew_route5 = merge_route.remote(nnew_route4, nroute5)
    ...
    jroute = ray.get(jnew_route5)
    kroute = ray.get(knew_route5)
    lroute = ray.get(lnew_route5)
    mroute = ray.get(mnew_route5)
    nroute = ray.get(nnew_route5)
