...
def fun():
    route0 = shortest_way(Location[0], 5)
    route1 = shortest_way(Location[1], 5)
    new_route1 = merge_route(route0, route1)
    route2 = shortest_way(Location[2], 5)
    new_route2 = merge_route(new_route1, route2)
    route3 = shortest_way(Location[3], 5)
    new_route3 = merge_route(new_route2, route3)
    route4 = shortest_way(Location[4], 5)
    new_route4 = merge_route(new_route3, route4)
    route5 = shortest_way(Location[4], 5)
    new_route5 = merge_route(new_route4, route5)
