...
CPP_SRCS += \
../packages/rosserial-melodic-latest/src/duration.cpp \
../packages/rosserial-melodic-latest/src/time.cpp 

OBJS += \
./packages/rosserial-melodic-latest/src/duration.o \
./packages/rosserial-melodic-latest/src/time.o 

CPP_DEPS += \
./packages/rosserial-melodic-latest/src/duration.d \
./packages/rosserial-melodic-latest/src/time.d 


# Each subdirectory must supply rules for building sources it contributes
packages/rosserial-melodic-latest/src/%.o: ../packages/rosserial-melodic-latest/src/%.cpp
